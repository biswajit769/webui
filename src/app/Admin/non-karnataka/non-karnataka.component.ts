...
@Component({
  selector: 'app-non-karnataka',
  templateUrl: './non-karnataka.component.html',
  styleUrls: ['./non-karnataka.component.css']
})
export class NonKarnatakaComponent implements OnInit {
...
public accounttype = ['Savings', 'Salary', 'Current'];
 ...
 public stayduration = ['less than 1 year', '1 to 3 Years', '3 to 5 Years', 'More than 5 Years'];
  ...
  // public status4: boolean = true;
   ...
   profile_detaile(){
    this.request.manage_nonkarnatak().subscribe(data =>{
